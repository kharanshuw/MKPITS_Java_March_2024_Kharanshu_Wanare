...
public class AccountManagement extends HttpServlet {
    ...
    public void verifyRegister(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            preparedStatement.setString(1, mynameString);
            preparedStatement.setString(2, addressString);
            preparedStatement.setString(3, cityString);
            preparedStatement.setString(4, phonenoString);
            preparedStatement.setString(7, (passwordString));
            preparedStatement.setDouble(5, Double.parseDouble(balanceString));
    ...
    public void VerifyLogin(HttpServletRequest request, HttpServletResponse response) throws ClassNotFoundException, SQLException, IOException {
        String emailString = request.getParameter("email");
        String passwordString = request.getParameter("password");
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String emailString1 = resultSet.getString(7);
                String passwordString1 = resultSet.getString(8);

                System.out.println(emailString1);
                System.out.println(passwordString1);

                if (emailString1.equals(emailString)) {
                ...
                System.out.println("password wrond");
        }
